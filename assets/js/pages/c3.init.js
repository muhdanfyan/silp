    ...
    t.prototype.init = function() {
        c3.generate({
            ...
            data: {
                ...
                type: "bar",
                colors: { Desktops: "#e3eaef", Tablets: "#009fb7", Mobiles: "#4fc6e1" }
            }
        }), c3.generate({
            ...
            data: {
                ...
                types: { Desktops: "bar", Tablets: "bar", Mobiles: "spline", Watch: "line", iPad: "bar" },
                colors: { Desktops: "#e3eaef", Tablets: "#009fb7", Mobiles: "#4fc6e1", Watch: "#fb6d9d", iPad: "#1abc9c" },
                groups: [
                    ["Desktops", "Tablets"]
                ]
            },
            ...
            data: {
                ...
                types: { Desktops: "bar" },
                colors: { Desktops: "#009fb7", Tablets: "#4fc6e1" }
            },
            ...
            data: {
                ...
                types: { Desktops: "area-spline", Tablets: "area-spline" },
                colors: { Desktops: "#009fb7", Tablets: "#4fc6e1" }
            }
        }), c3.generate({
            bindto: "#donut-chart",
            ...
            donut: { title: "Sales Analytics", width: 15, label: { show: !1 } },
            color: { pattern: ["#4fc6e1", "#009fb7", "#ebeff2"] }
        }), c3.generate({
            bindto: "#pie-chart",
            data: {
                columns: [
            ...
            data: {
                ...
                regions: { Desktops: [{ start: 1, end: 2, style: "dashed" }, { start: 3 }], Tablets: [{ end: 3 }] },
                colors: { Desktops: "#4fc6e1", Tablets: "#009fb7" }
            }
        }), c3.generate({
            bindto: "#scatter-plot",
            data: {
            ...
            color: { pattern: ["#4fc6e1", "#009fb7", "#4fc6e1", "#009fb7"] },
