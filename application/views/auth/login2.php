...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Login Pengontrollan Santri</title>
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                ...
                                <p class="text-white-50">Don't have an account? <a href="<?= base_url('auth/create_new_user') ?>" class="text-white ml-1"><b>Sign Up</b></a></p>
                            </div> <!-- end col -->
                        </div>
                        <!-- end row -->
