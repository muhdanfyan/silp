...
class Inputkader extends CI_Controller {
	...
	{        
		...
		// }
            ...
            $data['kader_t_ula'] = $this->Kader_model->get_kader(1,null);
            $data['kader_t_tsani'] = $this->Kader_model->get_kader(2,null);
            $data['kader_pra_t'] = $this->Kader_model->get_kader();
