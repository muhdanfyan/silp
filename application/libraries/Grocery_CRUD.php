...
class grocery_CRUD_Layout extends grocery_CRUD_Model_Driver
{
	...
	protected function get_integer_input($field_info,$value)
	{
		...
		$input = "<input id='field-{$field_info->name}' name='{$field_info->name}' type='text' placeholder='Input Data $field_info->name' value='$value' class='numeric form-control' $extra_attributes />";
		return $input;
	}
    ...
    protected function get_true_false_input($field_info,$value)
	{
		...
		$input .=
            ...
            <input type='radio' value=\"1\"  id='field-{$field_info->name}-true' name='{$field_info->name}' class='custom-control-input' id='field-{$field_info->name}-true'  $checked >
                <label class='custom-control-label' for='field-{$field_info->name}-true'>
                Ya
            </label></div>";
		...
		$input .=
			"<div class='custom-control custom-radio'>
            <input type='radio' value=\"1\"  id='field-{$field_info->name}-false' name='{$field_info->name}' class='custom-control-input' id='field-{$field_info->name}-true'  $checked >
            <label class='custom-control-label' for='field-{$field_info->name}-false'>
				Tidak
            </label></div>";
	...
	protected function get_string_input($field_info,$value)
	{
		...
		$input = "<input id='field-{$field_info->name}' class='form-control' name='{$field_info->name}' type='text' placeholder='Input Data $field_info->name' value=\"$value\" $extra_attributes />";
		return $input;
	}
	...
	protected function get_text_input($field_info,$value)
	{
		if($field_info->extras == 'text_editor')
		{
			...
			switch ($editor) {
				...
				case 'summernote':
					$this->set_css($this->default_texteditor_path.'summernote/summernote-bs4.css');
					$this->set_js_lib($this->default_texteditor_path.'/summernote/summernote-bs4.min.js');
					$this->set_js_lib($this->default_texteditor_path.'/ckeditor/adapters/jquery.js');
					$this->set_js_config($this->default_javascript_path.'/jquery_plugins/config/jquery.ckeditor.config.js');
				break;
			}
	...
	protected function get_datetime_input($field_info,$value)
	{
		...
		$input = "<input id='field-{$field_info->name}' name='{$field_info->name}' type='text' placeholder='Input Data $field_info->name' value='$datetime' maxlength='19' class='datetime-input form-control'   autocomplete='off'/>
	...
	protected function get_date_input($field_info,$value)
	{
		...
		$input = "<input id='field-{$field_info->name}' name='{$field_info->name}' type='text' placeholder='Input Data $field_info->name'  value='$date' maxlength='10' class='datepicker-input form-control' />
	...
	protected function get_dropdown_input($field_info,$value)
	{
		...
		$input = "<select id='field-{$field_info->name}' name='{$field_info->name}' class='chosen-select' data-placeholder='".$select_title."' style='width:100%'>";
	...
	protected function get_enum_input($field_info,$value)
	{
		...
		$input = "<select id='field-{$field_info->name}' name='{$field_info->name}' class='chosen-select' data-placeholder='".$select_title."' style='width:70%'>";
	...
	protected function get_set_input($field_info,$value)
	{
		...
		$select_title = str_replace('{field_display_as}',$field_info->display_as,$this->l('set_relation_title'));
		$input = "<select id='field-{$field_info->name}' name='{$field_info->name}[]' multiple='multiple' size='8' class='chosen-multiple-select' data-placeholder='$select_title' style='width:100%;' >";
	...
	protected function get_relation_n_n_input($field_info_type, $selected_values)
	{
		...
		else
		{
            ...
            $input = "<select id='field-{$field_info_type->name}' name='{$field_info_type->name}[]' multiple='multiple' size='8' class='$css_class' data-placeholder='$select_title' style='$width_style' >"; // style='$width_style'
